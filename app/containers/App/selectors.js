...
const makeSelectQuotes = () =>
  createSelector(selectGlobal, globalState => globalState.get('quotes'));

const makeSelectError = () =>
  createSelector(selectGlobal, globalState => globalState.get('error'));

const makeSelectRecentlySaved = () =>
  createSelector(selectGlobal, globalState => globalState.get('recentlySaved'));
